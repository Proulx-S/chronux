function [f,findx]=getfgrid2(Fs,nfft,fpass)
...
% Modified by Sebastien Proulx (2023-10-12) to allow complex number timeseries
...
% f=f(1:nfft);
%%%%%%%
f=0:df:(Fs-df); % all possible frequencies
f = f-Fs/2;
f = -f;
%%%%%%%
if length(fpass)~=1
